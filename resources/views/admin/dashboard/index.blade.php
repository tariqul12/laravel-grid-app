                            ...
                            <tbody class="table-body">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="data-image avatar avatar-md rounded-circle"
                                                style="background-image: url({{ asset('/') }}admin-assets/assets/images/users/11.jpg)"></span>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="data-image avatar avatar-md rounded-circle"
                                                style="background-image: url({{ asset('/') }}admin-assets/assets/images/users/12.jpg)"></span>
                                            <div class="user-details ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="data-image avatar avatar-md rounded-circle"
                                                style="background-image: url({{ asset('/') }}admin-assets/assets/images/users/13.jpg)"></span>
                                            <div class="user-details ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="data-image avatar avatar-md rounded-circle"
                                                style="background-image: url({{ asset('/') }}admin-assets/assets/images/users/4.jpg)"></span>
                                            <div class="user-details ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="data-image avatar avatar-md rounded-circle"
                                                style="background-image: url({{ asset('/') }}admin-assets/assets/images/users/5.jpg)"></span>
                                            <div class="user-details ms-2">
