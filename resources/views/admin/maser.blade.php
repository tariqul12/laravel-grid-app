...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('/') }}admin-assets/assets/images/brand/favicon.ico" />

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="{{ asset('/') }}admin-assets/assets/plugins/bootstrap/css/bootstrap.min.css"
        rel="stylesheet" />
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="{{ asset('/') }}admin-assets/assets/images/brand/logo.png"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{ asset('/') }}admin-assets/assets/images/brand/logo-3.png"
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a class="nav-link icon text-center country-nav-link"
                                                ...
                                                <img class="header-icons language" alt=""
                                                    src="{{ asset('/') }}admin-assets/assets/images/flags/us_flag.jpg">
                                            </a>
                                        </div>
                                        <!-- SEARCH -->
                                                ...
                                                <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/ecommerce/1.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 lh-1 mb-1 text-dark fw-500">TrueBasket
                                                                Metal Single Pot</p>
                                                    ...
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/ecommerce/2.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 lh-1 mb-1 text-dark fw-500">Authentic
                                                                chair with Canopy</p>
                                                            <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                                    class="text-green">In Stock</span></p>
                                                    ...
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/ecommerce/3.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 mb-1 text-dark fw-500">Casual
                                                                Sneakers Canvas</p>
                                                            <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                                    class="text-green">In Stock</span></p>
                                                            <span class="fs-12 fw-300 lh-1 mb-0">Quantity: 03</span>
                                                    ...
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/ecommerce/4.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 lh-1 mb-1 text-dark fw-500">Branded
                                                                Head Phones</p>
                                                            <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                    ...
                                                    <a class="dropdown-item d-flex p-4" href="cart.html">
                                                        <span
                                                            class="avatar avatar-lg br-5 me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/ecommerce/5.jpg"></span>
                                                        <div class="wp-60 cart-desc mt-1">
                                                            <p class="fs-13 lh-1 mb-1 text-dark fw-500">camera
                                                                lens (16mm f/1.4)</p>
                                                            <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                                    class="text-green">In Stock</span></p>
                                                ...
                                                <div class="message-menu ps2 overflow-hidden">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/users/1.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/users/15.jpg">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/users/12.jpg">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                            data-bs-image-src="{{ asset('/') }}admin-assets/assets/images/users/4.jpg">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown"
                                                ...
                                                <span>
                                                    <img src="{{ asset('/') }}admin-assets/assets/images/faces/6.jpg"
                                                        alt="profile-user"
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.html">
                            <img src="{{ asset('/') }}admin-assets/assets/images/brand/logo.png"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{ asset('/') }}admin-assets/assets/images/brand/logo-1.png"
                                class="header-brand-img toggle-logo" alt="logo">
                            <img src="{{ asset('/') }}admin-assets/assets/images/brand/logo-2.png"
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Sub Category</span><i
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/italy_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="spain"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/spain_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="india"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/india_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="french"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/french_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="russia"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/russia_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="germany"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/germany_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/argentina_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/uae_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/austria_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/mexico_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/china_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/poland_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/canada_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia"
                                            src="{{ asset('/') }}admin-assets/assets/images/flags/malaysia_flag.jpg"
                                ...
                                <div class="m-0 wp-70 text-dark d-flex align-items-center">
                                    <div class="me-2">
                                        <img alt="User Avatar" class="rounded-circle avatar-sm"
                                            src="{{ asset('/') }}admin-assets/assets/images/users/7.jpg">
                                    </div>
                                    <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}admin-assets/assets/images/users/8.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}admin-assets/assets/images/users/2.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}admin-assets/assets/images/users/11.jpg">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-lg"
                                                                src="{{ asset('/') }}admin-assets/assets/images/users/14.jpg">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="media mb-5 overflow-visible">
                                            <div class="me-3">
                                                <a href="profile.html"> <img
                                                        ...
                                                        src="{{ asset('/') }}admin-assets/assets/images/users/5.jpg">
                                                </a>
                                            </div>
